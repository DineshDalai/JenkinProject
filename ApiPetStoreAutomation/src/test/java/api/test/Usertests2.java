...
public class Usertests2 {
	...
	public void testPostuser() {
		...
		Response res = UserEndPoints2.createUser(pojoObject);
		res.then().log().all();
	...
	public void getuserByName() {
		...
		Response res = UserEndPoints2.Readuser(this.pojoObject.getUsername());
		res.then().log().all();
		Assert.assertEquals(res.getStatusCode(), 200);
	}
	...
	public void testUpdateByUserName() {
		...
		Response res = UserEndPoints2.UpdateUser(this.pojoObject.getUsername(), pojoObject);
		res.then().log().all();
		Assert.assertEquals(res.getStatusCode(), 200);
	...
	public void testDeleteuser() {
		...
		Response res = UserEndPoints2.DeleteUSer(this.pojoObject.getUsername());
		res.then().log().all();
		Assert.assertEquals(res.getStatusCode(), 200);
	}
}