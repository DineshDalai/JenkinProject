...
public class LoginPage extends BaseClass{
	...
	//LoginPage Locators
		...
		//	Helper.getDriver().findElement(Name_Textbox).clear();
			Helper.clearText(Name_Textbox);
			
			//Helper.getDriver().findElement(Name_Textbox).sendKeys(un);
			//logger.info("User Name Enter Sucessfully");
			Helper.EnterText(Name_Textbox, un);
			
			Helper.clearText(Password_Textbox);
		...
		public void ClickLoginButton() throws InterruptedException {
			...
			Helper.ClickOn_ByLocators(Login_button);
		...
		public void ClickLogOutButton() {
			...
			Helper.ClickOn_ByLocators(LogOut_button);
			//logger.info("Login button click sucessfully");
		}
}
